...
export default function AttendancePage() {
  ...
  return (<div className="space-y-6"><PageHeader title="Attendance" subtitle="Record daily attendance and time tracking" actions={<Button size="sm" onClick={openCreate}><Plus className="h-4 w-4 mr-2" />Mark Attendance</Button>} />
