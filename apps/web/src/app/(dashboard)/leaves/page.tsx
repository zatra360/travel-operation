...
export default function LeavesPage() {
  ...
  return (<div className="space-y-6"><div className="flex items-center justify-between"><h2 className="text-2xl font-bold">Leave Requests</h2><Button size="sm" onClick={openCreate}><Plus className="h-4 w-4 mr-2" />New Request</Button></div>
