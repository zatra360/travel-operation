...
const empty: FormState = { receiptNumber: '', invoiceId: '', paymentMethod: '', amount: '0', currencyCode: 'USD', reference: '', notes: '', receivedAt: '' };
