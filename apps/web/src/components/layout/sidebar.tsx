...
import {
  ...
  Calculator, Bell, Activity, Package, FileCheck, Globe,
...
const navGroups = [
  ...
  },
  {
    label: 'Team',
    items: [
      { label: 'Employees & Teams', href: '/employees', icon: Users, perm: 'EMPLOYEE_READ' },
  ...
  },
  {
    label: 'Reports',
    items: [
      { label: 'Finance', href: '/reports/finance', icon: BarChart3, perm: 'DASHBOARD_READ' },
      { label: 'Sales', href: '/reports/sales', icon: BarChart3, perm: 'DASHBOARD_READ' },
      { label: 'Leads', href: '/reports/leads', icon: BarChart3, perm: 'DASHBOARD_READ' },
      { label: 'Attendance', href: '/reports/attendance', icon: BarChart3, perm: 'DASHBOARD_READ' },
      { label: 'Tax', href: '/reports/tax', icon: BarChart3, perm: 'DASHBOARD_READ' },
      { label: 'Profit & Loss', href: '/reports/profit-loss', icon: BarChart3, perm: 'DASHBOARD_READ' },
    ],
  },
  {
    label: 'Settings',
    items: [
      ...
      { label: 'Service Catalog', href: '/service-catalog', icon: Package, perm: 'SETTINGS_READ' },
      ...
      { label: 'Knowledge Hub', href: '/knowledge', icon: BookOpen, perm: 'DASHBOARD_READ' },
      { label: 'GDS Tools', href: '/tools/gds', icon: Globe, perm: 'DASHBOARD_READ' },
      { label: 'Activity', href: '/activity', icon: Activity, perm: 'AUDIT_LOG_READ' },
    ],
  },
];
